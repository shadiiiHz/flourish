    ...
    <section className="relative px-3 py-12 sm:px-6">
      <div className="mx-auto max-w-6xl">
        ...
        <div className="relative">
          <div
            ref={trackRef}
            className="grid grid-flow-col auto-cols-[calc((100%_-_1rem)/1.25)] gap-4 overflow-x-auto snap-x snap-mandatory scroll-smooth px-1 pb-4 pt-1 sm:auto-cols-[calc((100%_-_2.5rem)/3)] sm:gap-5 lg:auto-cols-[calc((100%_-_5rem)/4)] [scrollbar-width:none] [&::-webkit-scrollbar]:hidden"
          >
            {items.map((item) => (
